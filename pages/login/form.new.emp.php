<div class="contenedor-new-emp w-100 vh-100">
    <div class="formulario d-flex justify-content-center align-items-center">
        <form class="w-75" action="Funciones/Login/Validaciones.php" method="post">
            <div class="input-group mb-3">
                <span class="input-group-text icono"><i class="bi bi-building"></i></span>
                <input type="text" class="form-control" name="nombre_empresa" placeholder="Ingrese el nombre de la empresa" required>
            </div>
            <div class="input-group mb-3">
