...
<div class="container">
  ...
  <form method="POST">
    <div class="input-group">
      <span class="input-group-text oferta"><i class="bi bi-building"></i></span>
      <input type="text" class="form-control" name="nombre_empresa" placeholder="Nombre de la empresa //aunque sera la logueada">
    </div>
    <div class="row">
      <div class="col-12">
        <span class="input-group-text oferta"><i class="bi bi-pencil-square"></i> Descripción de oferta</span>
        <textarea name="descripcion" class="form-control" placeholder="Descripción de oferta" cols="30" rows="10"></textarea>
      </div>
    </div>
    <div class="row">
      <div class="col-md-4">
        <span class="input-group-text oferta"><i class="bi bi-building"></i> Área de la empresa</span>
        <input type="text" class="form-control" name="area_empresa" placeholder="Área de la empresa">
      </div>
      <div class="col-md-4">
        <span class="input-group-text oferta"><i class="bi bi-person-square"></i> Cargo solicitado</span>
        <input type="text" class="form-control" name="cargo" placeholder="Cargo solicitado">
      </div>
      <div class="col-md-4">
        <span class="input-group-text oferta"><i class="bi bi-clipboard"></i> Tipo de contratación</span>
    ...
    <div class="row">
      <div class="col-md-6">
        <label class="input-group-text oferta" for="inputGroupSelect01"><i class="bi bi-mortarboard"></i> Educación mínima</label>
      ...
      <div class="col-md-6">
        <label class="input-group-text oferta" for="inputGroupSelect02"><i class="bi bi-person-plus"></i> Experiencia</label>
    ...
    <div class="row">
      <div class="col-md-4">
        <span class="input-group-text oferta"><i class="bi bi-123"></i> Rango de edad</span>
        <input type="text" class="form-control" name="edad" placeholder="Rango de edad">
      </div>
      <div class="col-md-4">
        <span class="input-group-text oferta"><i class="bi bi-currency-dollar"></i> Salario mínimo</span>
        <input type="number" min="0.00" class="form-control" name="salario_min" placeholder="Salario mínimo">
      </div>
      <div class="col-md-4">
        <span class="input-group-text oferta"><i class="bi bi-currency-dollar"></i> Salario máximo</span>
        <input type="number" min="0.00" class="form-control" name="salario_min" placeholder="Salario máximo">
      </div>
    </div>
    <div class="row">
      <a class="col-3 btn btn-outline-secondary" href="empresas_ver_ofertas.php" role="button">Volver</a>
      <button type="submit" class="col-6 btn btn-primary" name="guardar_oferta">Guardar</button>
    </div>
  </form>
</div>
<!-- Fin Formulario -->